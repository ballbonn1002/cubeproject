...
<div class="portlet light bordered">
	...
	<a class="btn btn-xs red" href="userAllReport"><i class="fa fa-pencil"></i> Print </a>
		...
		<div class="actions right">
			<button type="button" class="btn green-jungle" id="addUser" onclick="add()">
	...
	<div class="test">
		<jsp:include page="/pages-back/editpagetest/radio_user_list_test.jsp" flush="true"></jsp:include>
	</div>
...
<script>
	function add() {
		document.location = "user-add-test";
	}
</script>
