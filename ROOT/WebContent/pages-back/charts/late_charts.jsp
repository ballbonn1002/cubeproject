...
<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="caption">
			<i class="icon-bar-chart font-red"></i> <span
				class="caption-subject font-red sbold ">10 Employee Check-in Late</span>
		</div>
		<div class="actions">
	...
	<div class="row">
		<form method="post" name="form" action="checkinLateChart">
		<div class="col-lg-8">
			<div class="col-lg-6 col-md-12" style="margin-right:-15px; text-align:center; margin-top: 20px" >
			...
			<div class="col-lg-6 col-md-12" style="text-align:center; margin-top: 20px">
				<div class="form-group form-md-line-input ">
				<div class="col-lg-2">
		...
		<div class="col-lg-2 col-md-10" style="text-align:center; margin-top: 20px">
			<div class="form-group form-md-line-input ">
