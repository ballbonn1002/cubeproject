...
<div class="portlet light bordered">
	...
	<div class="portlet-body">
		<form class="form-inline margin-bottom-40" action="search_leavecharts_all" style="margin-left: 20%;" method="post">
			...
			<button type="submit" class="btn sbold blue" > <i class="fa fa-search"></i> Search</button>
		</form>
	</div>
</div>
<div class="portlet light bordered">
	<div class="portlet-title">
		...
		<div class="caption">
			<i class="icon-bar-chart font-blue"></i> <span
				class="caption-subject font-red sbold ">LEAVES Total of Month</span>
		</div>
		<div class="actions">
			<a class="btn btn-circle btn-icon-only btn-default fullscreen"
				href="javascript:;" data-original-title="" title=""> </a>
