...
<div class="portlet light ">
	<div class="portlet-title">
		...
		<div class="actions">
			<a href="eAdd" class="btn green-meadow"><i class="fa fa-plus"></i>
				Add new</a>
		</div>
	</div>
		...
		<table
			...
			<thead>
				...
				<tr style="background-color: rgb(59, 63, 81); color: white; height: 41px">
					...
					<th class="none">Borrower History</th>
					<th class="all"></th>
				</tr>
			</thead>
			<tbody id='tbody'>
            ...
            "columns": [
                ...
                { "data": "", "defaultContent": "",
                	"render": function (data, type, row) {
                        ...
                        let id = data; 
                        let s = row["status"];
                       output += '<a class="btn btn-xs blue-dark" href="borrower-list?id='+row["equipmentId"]+'"><i class="fa fa-eye"></i>&nbsp<label>View</label></a>';
                    return output;
                    }
                },
                {   "data": "equipmentId",
