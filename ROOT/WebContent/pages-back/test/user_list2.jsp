...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			<i class="icon-user font-red"></i> <span id="asdasd"
				...
				LIST</span>
				<a class="btn btn-xs red-mint" href="userAllReport">Print PDF</a>
		</div>
		<perm:permission object="user.edit">
		<div class="actions right">
			<button type="button" class="btn btn-sm green-meadow" id="addUser" onclick="add()">
	...
	<div class="test">
		<jsp:include page="/pages-back/test/radio_user_list2.jsp" flush="true"></jsp:include>
	</div>
</div>
